...
CODING_AGENT_GUIDANCE = (
    ...
    "- For multi-step tasks, use `todo` to lay out the plan: what files to touch, "
    "in what order, and how to verify each step. Keep the plan visible so you "
    "and the user share the same map.\n"
    "- Start with the smallest change that moves toward the goal. Add one "
    "piece at a time and verify before moving to the next.\n"
    "\n"
